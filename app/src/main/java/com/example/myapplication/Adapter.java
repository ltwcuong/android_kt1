...
public class Adapter extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        TextView text3 = view.findViewById(R.id.dcct);
        TextView text4 = view.findViewById(R.id.soSao);
        ImageView imageV = view.findViewById(R.id.imageHinh);

        text1.setText(thongtin.getTen());
        text2.setText(thongtin.getCapbac());
        text3.setText(thongtin.getNoicongtac());
        text4.setText(thongtin.getSoSao());
